...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Server_tmp->setGeometry(QRect(0, 240, 401, 21));
        ...
        Server_Web_Open->setGeometry(QRect(150, 170, 171, 31));
        ...
        Server_Rep_Host->setGeometry(QRect(150, 210, 171, 31));
        ...
        Web_WebCam_Restart->setGeometry(QRect(210, 130, 61, 31));
        ...
        Web_WebCam_Stop->setGeometry(QRect(280, 130, 41, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Web_WebCam_Restart->setText(QApplication::translate("MainWindow", "RESTART", Q_NULLPTR));
